...
export default function Menu() {
	...
	const darkHeader = pathname === '/' || pathname === '/home' || pathname === pages.parceiros || pathname === pages.sobre || pathname === pages.sobreAgp || pathname === pages.sobreIct || pathname === '/404' || isNotFound
