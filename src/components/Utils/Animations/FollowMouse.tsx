...
export default function FollowMouse({
    ...
    return (
        ...
        >
            ...
            <div
                className='fixed z-2 flex items-center justify-center w-35 min-w-35 h-35 rounded-full bg-green-dark/90 x text-black pointer-events-none transform scale-0 max-md:hidden font-heading uppercase text-xl font-semibold'
                ref={object}
            >
                {text}
            </div>
