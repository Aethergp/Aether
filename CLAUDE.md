...
|---|---|---|
| `AnimatedTitle` | Per-line two-tone gradient **fill** (`.fill-title`), `backgroundPositionX` scrubbed `top 75%`→`bottom 60%` | `style: 'light'\|'dark'\|'vinho'` (`dark`=fills to green-dark, `vinho`=fills to `#3D0108` for the Bio+/ICT page) |
